...
CLOUD_TRAINING_LEGACY_PROVIDER_ADAPTER_CONTRACT_VERSION = (
    "hfr.cloud_training_provider_adapter.v1"
)
CLOUD_TRAINING_PROVIDER_ADAPTER_CONTRACT_VERSION = (
    "hfr.cloud_training_provider_adapter.v2"
)

LEGACY_PROVIDER_ADAPTER_RECEIPT_TYPES: tuple[str, ...] = (
...
PROVIDER_ADAPTER_RECEIPT_TYPES_BY_VERSION: dict[str, tuple[str, ...]] = {
    CLOUD_TRAINING_LEGACY_PROVIDER_ADAPTER_CONTRACT_VERSION: (
        LEGACY_PROVIDER_ADAPTER_RECEIPT_TYPES
    ),
    CLOUD_TRAINING_PROVIDER_ADAPTER_CONTRACT_VERSION: (
